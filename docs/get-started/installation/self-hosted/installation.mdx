...
2. Copy the contents from the [file](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose.env) and paste them into the docker-compose.env file.
...
2. Copy the contents from the [file(Linux-86_64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose.yml) and paste them into the docker-compose.yml file.
...
1. Create an empty docker-compose.yml file.
2. Copy the contents from the [file(macOS-arm64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose-macOS-arm64.yml) and paste them into the docker-compose.yml file.
...
1. Create an empty docker-compose.yml file.
2. Copy the contents from the [file(windows&macOS-x86_64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose-macOS-windows-x86_64.yml) and paste them into the docker-compose.yml file.
