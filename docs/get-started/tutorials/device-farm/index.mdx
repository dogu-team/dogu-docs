...
1. Please visit the [Dogu Agent for Cloud](https://dogutech.io/downloads/dogu-agent) or [Dogu Agent for Self-Hosted](https://github.com/dogu-team/dogu-self-hosted/releases) page and select the appropriate platform for your host to install the latest Dogu Agent program.
