...
:::info PREREQUISITES
Before using the devices, you need to have a host added. Refer to the [Adding a Host](/get-started/tutorials/device-farm/host/windows) documentation for instructions on adding a host.
:::
