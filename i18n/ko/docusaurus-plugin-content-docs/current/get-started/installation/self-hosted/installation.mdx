...
2. [파일](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose.env) 내용을 docker-compose.env 파일에 붙여넣기
...
2. [파일(Linux-x86_64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose.yml) 내용을 docker-compose.yml 파일에 붙여넣기
...
1. 빈 docker-compose.yml 파일 생성
2. [파일(macOS-arm64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose-macOS-arm64.yml) 내용을 docker-compose.yml 파일에 붙여넣기

</TabItem>
<TabItem value="windows/macOS(x86_64)" label="windows/macOS(x86_64)">

1. 빈 docker-compose.yml 파일 생성
2. [파일(windows&macOS-x86_64)](https://github.com/dogu-team/dogu-self-hosted/blob/main/docker-compose-macOS-windows-x86_64.yml) 내용을 docker-compose.yml 파일에 붙여넣기
